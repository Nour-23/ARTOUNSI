...
final class CategoryOffreController extends AbstractController
{
    ...
    #[Route('/{id}', name: 'app_category_offre_show_front', methods: ['GET'])]
    public function showfront(CategoryOffre $categoryOffre): Response
    {
        return $this->render('category_offre/show_front.html.twig', [
            'category_offre' => $categoryOffre,
        ]);
    }
