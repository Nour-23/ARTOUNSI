...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\ManyToMany(targetEntity: Formation::class, mappedBy: 'participations')]
    ...
    public function addFormtion(Formation $formation): static
    {
        if (!$this->formation->contains($activite)) {
            $this->formation->add($activite);
            $formation->addReservation($this);
        }

        return $this;
    }

    public function removeFormations(Formation $formation): static
    {
        if ($this->formation->removeElement($formation)) {
            $formation->removeReservation($this);
        }
