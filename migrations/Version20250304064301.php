 ...
 */
final class Version20250304064301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, familyname VARCHAR(50) NOT NULL, email VARCHAR(255) NOT NULL, cin VARCHAR(8) NOT NULL, verification_code VARCHAR(255) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, verification_token VARCHAR(255) DEFAULT NULL, archived TINYINT(1) NOT NULL, is_active TINYINT(1) NOT NULL, numtel VARCHAR(8) NOT NULL, date_naissance DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', adresse VARCHAR(255) NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, token_expiry DATETIME DEFAULT NULL, nsc VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', google_id VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, login_count INT NOT NULL, UNIQUE INDEX UNIQ_8D93D649ABE530DA (cin), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
